 ...
 * @subpackage Moving_Digital_Realworks/public
 */
 ...
 */
class Moving_Digital_Realworks_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/moving-digital-realworks-public.js', array( 'jquery' ), $this->version, false );
